...
export class CitiesServiceProxy {
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<CitiesDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CitiesDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CitiesDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<CitiesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CitiesDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CitiesDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<CitiesDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<CitiesDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<CitiesDtoPagedResultDto>;
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<CitiesDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CitiesDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CitiesDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: CitiesDto | undefined): Observable<CitiesDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<CitiesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: CitiesDto | undefined): Observable<CitiesDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<CitiesDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CountriesServiceProxy {
    ...
    getAllforcountries(): Observable<CountryDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Countries/GetAll?";
        let options_ : any = {
            observe: "response",
            responseType: "blob",
...
@Injectable()
export class PhonebookServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<PhonebookDto> {
        let url_ = this.baseUrl + "/api/services/app/Phonebook/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PhonebookDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PhonebookDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PhonebookDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PhonebookDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PhonebookDto>(null as any);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<PhonebookDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Phonebook/GetAll?";
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PhonebookDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PhonebookDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PhonebookDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PhonebookDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PhonebookDtoPagedResultDto>(null as any);
    }
     ...
     * @return Success
     */
    create(body: PhonebookDto | undefined): Observable<PhonebookDto> {
        let url_ = this.baseUrl + "/api/services/app/Phonebook/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<PhonebookDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    update(body: PhonebookDto | undefined): Observable<PhonebookDto> {
        let url_ = this.baseUrl + "/api/services/app/Phonebook/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<PhonebookDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Phonebook/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class Cities implements ICities {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.country = _data["country"] ? Countries.fromJS(_data["country"]) : <any>undefined;
            if (Array.isArray(_data["phonebooks"])) {
                this.phonebooks = [] as any;
                for (let item of _data["phonebooks"])
                    this.phonebooks.push(Phonebook.fromJS(item));
            }
        }
    }
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["countries"])) {
                ...
                for (let item of _data["countries"])
                    this.countries.push(Countries.fromJS(item));
            }
            if (Array.isArray(_data["phonebooks"])) {
                this.phonebooks = [] as any;
                for (let item of _data["phonebooks"])
...
export class CitiesDtoPagedResultDto implements ICitiesDtoPagedResultDto {
    items: CitiesDto[] | undefined;
    totalCount: number;

    constructor(data?: ICitiesDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CitiesDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new CitiesDtoPagedResultDto();
        result.init(data);
        return result;
    }
...
export interface ICitiesDtoPagedResultDto {
    items: CitiesDto[] | undefined;
    totalCount: number;
}
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["cities"])) {
                ...
                for (let item of _data["cities"])
                    this.cities.push(Cities.fromJS(item));
            }
        }
    }
...
export class Phonebook implements IPhonebook {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.city = _data["city"] ? Cities.fromJS(_data["city"]) : <any>undefined;
        }
    }
...
export class PhonebookDtoPagedResultDto implements IPhonebookDtoPagedResultDto {
    items: PhonebookDto[] | undefined;
    totalCount: number;

    constructor(data?: IPhonebookDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(PhonebookDto.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): PhonebookDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new PhonebookDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PhonebookDtoPagedResultDto {
        const json = this.toJSON();
        let result = new PhonebookDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IPhonebookDtoPagedResultDto {
    items: PhonebookDto[] | undefined;
    totalCount: number;
}
