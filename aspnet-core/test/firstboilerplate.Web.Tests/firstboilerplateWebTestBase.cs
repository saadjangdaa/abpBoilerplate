...
{
    public abstract class firstboilerplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static firstboilerplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(firstboilerplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<firstboilerplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<firstboilerplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<firstboilerplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<firstboilerplateDbContext, Task<T>> func)
        {
            T result;
